pos = 0;
sc_client_id = "da7fd01a909b42f7145ae301fe2cff5c";
current_track = null;
current_soundcloud_data = null;
apiurl = '/api';
...
//  var playlistline = "<tr>";
//  playlistline += "<td></td>";
//  playlistline += "<td>"+artist.substring(0,20)+"</td>";
//  playlistline += "<td>"+poster_name.substring(0,20)+"</td>";
//  playlistline += "<td>"+forum_name.substring(0,20)+"</td>";
//  // playlistline += "<td>"+time+"</td>";
//  playlistline += "</tr>";
